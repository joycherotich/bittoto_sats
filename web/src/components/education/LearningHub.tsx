...
const LearningHub: React.FC<LearningHubProps> = ({ childId, onBack }) => {
  ...
  // Define effectiveChildId using the childId prop
  const effectiveChildId = childId;

  // Use effectiveChildId in your API calls
  useEffect(() => {
    const fetchModules = async () => {
      ...
      try {
        ...
        if (isParent && effectiveChildId) {
          ...
          console.log(
            `Fetching learning progress for child: ${effectiveChildId}`
          );
          modulesData = await api?.getChildLearningProgress(effectiveChildId);
        } else {
          // For child viewing their own progress
          console.log('Fetching own learning modules');
    ...
    fetchModules();
  }, [api, effectiveChildId, isParent, toast]);
      ...
      if (api) {
        ...
        setModules((prevModules) =>
          prevModules.map((module) => ({
            ...
            completedLessons: module.lessons.some(
        ...
        if (selectedModule) {
          setSelectedModule({
            ...
            completedLessons: selectedModule.lessons.some(
              (l) => l.id === lessonId && !l.completed
            )
        ...
        lessons: [
          {
            ...
            content:
              'Bitcoin is a digital currency that was created in 2009 by an unknown person using the alias Satoshi Nakamoto. Unlike traditional currencies, Bitcoin operates without a central bank or single administrator.',
            completed: true,
            moduleId: '1',
            rewardAmount: 10,
          },
          {
            ...
            content:
              'Bitcoin works on a technology called blockchain. This is a public ledger that records all transactions. It is maintained by a network of computers around the world.',
            completed: false,
            moduleId: '1',
            rewardAmount: 15,
          },
          {
            ...
            content:
              'A Bitcoin wallet is a digital wallet where you can store, send, and receive Bitcoin. There are different types of wallets including hardware wallets, software wallets, and paper wallets.',
            completed: false,
            moduleId: '1',
            rewardAmount: 20,
          },
        ...
        lessons: [
          {
            ...
            content:
              'Bitcoin can be a good way to save money because it is not controlled by any government or bank. This means it cannot be printed like traditional money, which can cause inflation.',
            completed: false,
            moduleId: '2',
            rewardAmount: 15,
          },
          {
            ...
            content:
              'Setting savings goals is important. You should decide how much Bitcoin you want to save and by when. This will help you track your progress and stay motivated.',
            completed: false,
            moduleId: '2',
            rewardAmount: 20,
          },
          ...
          <CardHeader>
            ...
            <div className='mt-2'>
              <div className='flex justify-between text-xs mb-1'>
                ...
                <span>
                  {selectedModule.completedLessons}/
                  {selectedModule.totalLessons} lessons completed
                </span>
              </div>
              <Progress
                value={
        ...
        <Card>
          ...
          <CardContent>
            <div className='prose max-w-none'>
              ...
              <p>
                This is where the full lesson content would be displayed,
                including text, images, videos, and interactive elements to help
                children learn about Bitcoin and financial literacy.
              </p>
            </div>
