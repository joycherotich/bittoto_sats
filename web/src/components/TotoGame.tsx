...
const questions = [
  {
    ...
    correctAnswer: 0,
    explanation: "Bitcoin is a digital currency that uses cryptography for security and operates without a central authority."
  },
  {
    ...
    correctAnswer: 1,
    explanation: "A satoshi is the smallest unit of Bitcoin, named after Bitcoin's creator Satoshi Nakamoto. 1 Bitcoin = 100,000,000 satoshis."
  },
  {
    ...
    correctAnswer: 2,
    explanation: "When you save money, it can grow over time through interest or investments, helping you buy bigger things later."
  },
  {
    ...
    correctAnswer: 0,
    explanation: "Saving money is important so you can buy things you need in the future, like education, a home, or for emergencies."
  },
  {
    ...
    correctAnswer: 3,
    explanation: "There are 100,000,000 (one hundred million) satoshis in 1 Bitcoin."
  },
  {
    ...
    correctAnswer: 1,
    explanation: "A Bitcoin wallet is a digital tool that stores the private keys needed to access and manage your Bitcoin."
  },
  {
    ...
    correctAnswer: 1,
    explanation: "The Lightning Network is a second layer built on top of Bitcoin that allows for faster and cheaper transactions."
  },
  {
    ...
    correctAnswer: 1,
    explanation: "If you spend all your money right away, you won't have any left for important things you might need or want later."
  }
];
        ...
        <Card className="shadow-lg border-2 border-amber-200">
          <CardHeader className="bg-gradient-to-r from-amber-400 to-amber-500 text-white">
            <div className="flex justify-between items-center">
              ...
              <Badge className={`${timeLeft <= 5 ? 'bg-red-500' : 'bg-green-500'}`}>
                {timeLeft}s
              </Badge>
            </div>
            <Progress 
        ...
        <Card>
          ...
          <CardContent className="p-6 text-center">
            <div className="mb-6">
              ...
              <p className="text-lg mb-4">You earned <span className="font-bold text-amber-500">{earnedSats} sats</span>!</p>
              ...
              {score >= questions.length * 15 ? (
                ...
                <div className="bg-amber-50 p-4 rounded-lg border border-amber-100 mb-4">
                  ...
                  <p>You're learning about Bitcoin. Play again to improve your score!</p>
                </div>
              )}
            </div>
